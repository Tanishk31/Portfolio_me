...
//         </div>
//         <a
//           href="#contact" className="btn btn-secondary max-md:hidden
...
const Header = () => {
  const [navOpen, setNavOpen] = useState(false); // Initially false, since navbar is closed
      ...
      <div className="max-w-screen-2xl w-full mx-auto px-4 flex justify-between items-center md:px-6 md:grid md:grid-cols-[1fr,3fr,1fr]">
        ...
        <div className="relative md:justify-self-center">
          <button 
            ...
            onClick={() => setNavOpen(prev => !prev)} // Toggle between open/close
          >
            <span className="material-symbols-rounded">
              {navOpen ? 'close' : 'menu'}
            </span>
