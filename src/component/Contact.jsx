   ...
   <section
    ...
    className='section'>
        <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
            ...
            <form action="https://getform.io/f/arolkgdb"
            method="Post"
            className='xl:pl-10 2xl:pl-20 '>
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        autoComplete='email'
                        required
                        placeholder='tanishkchaudhary3108@gmail.com'
                        className='text-field reveal-up'/>
                    </div>
                </div>
                <div className="mb-4">
                <label
                htmlFor='message' className='label reveal-up'>
                    Message
                    </label> 
